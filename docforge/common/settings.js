/**
 * DocForge User Settings
 * Handles UI size, contrast, and saved templates (bookmarks)
 */

const DocForgeSettings = (function() {
    'use strict';

    const STORAGE_KEY = 'docforge_settings';
    const TEMPLATES_KEY = 'docforge_saved_templates';
        ...
        const html = `
            <div class="size-picker">
                ...
                <button class="size-btn ${settings.size === 'normal' ? 'active' : ''}" 
                        data-size="normal" 
                        onclick="DocForgeSettings.setSize('normal')"
                        title="Normal size">
                    A
                </button>
                <button class="size-btn ${settings.size === 'large' ? 'active' : ''}" 
                        data-size="large" 
                        onclick="DocForgeSettings.setSize('large')"
                        title="Large size">
                    A
                </button>
                <button class="size-btn ${settings.size === 'xlarge' ? 'active' : ''}" 
                        data-size="xlarge" 
                        onclick="DocForgeSettings.setSize('xlarge')"
...
if (typeof window !== 'undefined') {
    window.DocForgeSettings = DocForgeSettings;
}
