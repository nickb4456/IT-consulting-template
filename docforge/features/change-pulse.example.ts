 ...
 * 
 * Shows how to integrate pulse animations with common DocForge operations
 */
...
function createPulseToggle(): HTMLElement {
  ...
  container.className = 'docforge-setting';
...
// ============================================================
// Example 7: Integration with DocForge Command System
// ============================================================

interface DocForgeCommand {
  id: string;
  execute: () => Promise<Word.Range[]>;
}

async function executeWithPulse(command: DocForgeCommand): Promise<void> {
  try {
