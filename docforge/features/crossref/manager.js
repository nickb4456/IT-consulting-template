/**
 * DocForge Cross-Reference Manager
 * 
 ...
 * Enable via: DocForgeState.actions.enableFeature('crossref')
 */
function isEnabled() {
    if (typeof DocForgeState !== 'undefined') {
        return DocForgeState.actions.isFeatureEnabled('crossref');
    }
    return false;
}
