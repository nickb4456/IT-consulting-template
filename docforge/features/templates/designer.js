/**
 * DocForge Template Designer - Core Logic
 * 
...
const DocForgeTemplateDesigner = (function() {
    'use strict';
    ...
    async function saveTemplate(name, scope = 'personal') {
        ...
        if (typeof DocForgeVersionedStorage !== 'undefined') {
            await DocForgeVersionedStorage.Templates.save(template.id, template);
        } else {
...
if (typeof module !== 'undefined' && module.exports) {
    module.exports = DocForgeTemplateDesigner;
}
