/**
 * DocForge Template Designer - UI Controller
 * 
...
(function() {
    ...
    window.insertFieldInDocument = async function(fieldId) {
        ...
        if (typeof DocForgeTemplateDesigner !== 'undefined' && DocForgeTemplateDesigner.insertFieldAtCursor) {
            try {
                await DocForgeTemplateDesigner.insertFieldAtCursor(field);
