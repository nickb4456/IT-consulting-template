...
const FeatureDiscovery = (() => {
    // ============================================================================
    // Feature Definitions - The Complete DocForge Feature Set
    // ============================================================================
    ...
    function executeAction(actionName) {
        ...
        const actionMap = {
            'runPreflight': () => window.DocForge?.runPreflight?.() || document.getElementById('preflightBtn')?.click(),
            'runTypoShield': () => window.DocForge?.runTypoShield?.(),
            'runPartyChecker': () => window.DocForge?.runPartyChecker?.(),
            'showHealthDashboard': () => window.DocForge?.showHealthDashboard?.(),
