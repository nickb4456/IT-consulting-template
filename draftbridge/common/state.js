/**
 * DraftBridge State Management
 * 
 * Centralized state management for the DraftBridge application.
...
if (typeof window !== 'undefined') {
    window.DraftBridgeState = DraftBridgeState;
}
