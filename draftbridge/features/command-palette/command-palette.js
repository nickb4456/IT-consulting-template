...
const STORAGE_KEYS = {
    RECENT_COMMANDS: 'draftbridge_command_palette_recent',
    COMMAND_STATS: 'draftbridge_command_palette_stats'
};
 ...
 * All DraftBridge commands are registered here for discoverability.
 */
...
/**
 * Register all built-in DraftBridge commands.
...
function registerBuiltInCommands() {
    registerCommands([
            ...
            execute: async () => {
                if (window.FillEngine) {
                    ...
                    return window.FillEngine.fillTemplate(
                        window.DraftBridgeState?.schema,
                        window.DraftBridgeState?.dataset
                    );
                }
            },
            isEnabled: () => !!window.FillEngine && !!window.DraftBridgeState?.schema
        },
        {
        ...
        },
        {
            ...
            execute: () => {
                if (window.DraftBridgeUI?.showPanel) {
                    window.DraftBridgeUI.showPanel('designer');
                }
            }
        },
        {
        ...
        // === NUMBERING ===
        {
            ...
            execute: () => {
                if (window.DraftBridgeUI?.showPanel) {
                    window.DraftBridgeUI.showPanel('numbering');
                }
            }
        },
        {
        ...
        // === HEADERS & FORMATTING ===
        {
            ...
            execute: () => {
                if (window.DraftBridgeUI?.showPanel) {
                    window.DraftBridgeUI.showPanel('insert-header');
                }
            }
        },
        {
        ...
        },
        {
            ...
            execute: () => {
                if (window.DraftBridgeUI?.showPanel) {
                    window.DraftBridgeUI.showPanel('clause-vault');
                }
            }
        },
        {
        ...
        // === DOCUMENT CHECKS ===
        {
            ...
            execute: () => {
                if (window.DraftBridgeUI?.showPanel) {
                    window.DraftBridgeUI.showPanel('preflight');
                }
            }
        },
        {
        ...
        // === DIFF & COMPARE ===
        {
            ...
            execute: () => {
                if (window.DraftBridgeUI?.showPanel) {
                    window.DraftBridgeUI.showPanel('diff');
                }
            }
        },
        {
        ...
        },
        {
            ...
            execute: () => {
                if (window.DraftBridgeUI?.showPanel) {
                    window.DraftBridgeUI.showPanel('versions');
                }
            }
        },
        ...
        // === NAVIGATION ===
        {
            ...
            execute: () => {
                ...
                if (window.DraftBridgeUI?.promptInput) {
                    window.DraftBridgeUI.promptInput('Enter page number:', async (pageNum) => {
                        return Word.run(async (context) => {
        ...
        },
        {
            ...
            execute: () => {
                if (window.DraftBridgeUI?.showPanel) {
                    window.DraftBridgeUI.showPanel('navigation');
                }
            }
        },
        ...
        // === SETTINGS ===
        {
            ...
            label: 'Open Settings',
            category: 'Settings',
            description: 'Configure DraftBridge preferences',
            keywords: ['settings', 'preferences', 'options', 'configure'],
            execute: () => {
                if (window.DraftBridgeUI?.showPanel) {
                    window.DraftBridgeUI.showPanel('settings');
                }
            }
        },
        {
            ...
            execute: () => {
                if (window.DraftBridgeUI?.showPanel) {
                    window.DraftBridgeUI.showPanel('shortcuts');
                }
            }
        },
        ...
        // === HELP ===
        {
            ...
            category: 'Help',
            description: 'View DraftBridge documentation',
            shortcut: 'F1',
            keywords: ['help', 'docs', 'documentation', 'manual'],
            execute: () => {
                window.open('https://docs.draftbridge.app', '_blank');
            }
        },
        {
            id: 'help.about',
            label: 'About DraftBridge',
            category: 'Help',
            description: 'View version and license information',
            keywords: ['about', 'version', 'info'],
            execute: () => {
                if (window.DraftBridgeUI?.showPanel) {
                    window.DraftBridgeUI.showPanel('about');
                }
            }
        },
        {
            ...
            execute: () => {
                window.open('https://support.draftbridge.app/issues', '_blank');
            }
        }
    ]);
}
