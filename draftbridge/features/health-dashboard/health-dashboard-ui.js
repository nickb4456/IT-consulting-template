/**
 * DraftBridge Document Health Dashboard - UI
 * 
...
/* global DraftBridgeHealthDashboard */
...
function initHealthDashboardUI() {
    dashboard = new DraftBridgeHealthDashboard.Dashboard();
...
function buildCategoryCards(report) {
    const categories = DraftBridgeHealthDashboard.CATEGORIES;
