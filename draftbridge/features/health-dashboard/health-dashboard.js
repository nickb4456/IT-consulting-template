/**
 * DraftBridge Document Health Dashboard - Core Engine
 * 
...
/* global Word, Office, DraftBridgePreflight, CrossRefManager */
...
class HealthDashboard {
    constructor(options = {}) {
        ...
        this.options = {
            ...
            storageKey: options.storageKey || 'draftbridge_health_history',
            ...options
        };
...
HealthDashboard.prototype._tryDelegatePartyChecker = async function() {
    if (typeof window !== 'undefined' && window.DraftBridgePartyChecker) {
        try {
            const result = await window.DraftBridgePartyChecker.scanDocument();
...
const DraftBridgeHealthDashboard = {
...
// ES modules
export default DraftBridgeHealthDashboard;
export { HealthDashboard, HEALTH_CATEGORIES, SEVERITY_THRESHOLDS };

// Global
if (typeof window !== 'undefined') {
    window.DraftBridgeHealthDashboard = DraftBridgeHealthDashboard;
}

// CommonJS
if (typeof module !== 'undefined' && module.exports) {
    module.exports = DraftBridgeHealthDashboard;
}
