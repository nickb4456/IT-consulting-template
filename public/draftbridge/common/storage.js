...
const STORAGE_KEYS = {
    // Auth
    AUTH: 'draftbridge_auth',
    
    // Templates
    TEMPLATES: 'draftbridge_templates',
    DATASETS: 'draftbridge_datasets',
    RECENT_DATASETS: 'draftbridge_recent_datasets',
    
    // Numbering
    NUMBERING_PERSONAL: 'draftbridge_numbering_personal',
    NUMBERING_FIRM_CACHE: 'draftbridge_numbering_firm_cache',
    NUMBERING_STATE: 'draftbridge_numbering_state',
    
    // Letterhead
    FIRM_CONFIG: 'draftbridge_firm_config',
    ATTORNEYS: 'draftbridge_attorneys',
    
    // User state
    USER_PREFERENCES: 'draftbridge_preferences',
    RECENT_FILES: 'draftbridge_recent_files',
    
    // Sync
    SYNC_QUEUE: 'draftbridge_sync_queue',
    CACHE_METADATA: 'draftbridge_cache_meta'
};
...
function getStorageStats() {
    ...
    for (let i = 0; i < localStorage.length; i++) {
        ...
        if (key.startsWith('draftbridge_')) {
...
if (typeof module !== 'undefined' && module.exports) {
    module.exports = DraftBridgeStorage;
}

// Global
if (typeof window !== 'undefined') {
    window.DraftBridgeStorage = DraftBridgeStorage;
}
