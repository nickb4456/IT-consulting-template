...
describe('ChangePulse', () => {
  ...
  describe('preferences', () => {
    ...
    it('should persist disabled state', () => {
      ...
      expect(localStorage.getItem('draftbridge_pulse_enabled')).toBe('false');
    });
    ...
    it('should persist enabled state', () => {
      ...
      expect(pulse.isEnabled()).toBe(true);
      expect(localStorage.getItem('draftbridge_pulse_enabled')).toBe('true');
    });
    
    it('should load preference from storage', () => {
      localStorage.setItem('draftbridge_pulse_enabled', 'false');
...
describe('Notification', () => {
  it('should create notification element', () => {
    ...
    const hasStyles = Array.from(styleElements).some(
      el => el.textContent?.includes('draftbridge-pulse-notification')
    );
