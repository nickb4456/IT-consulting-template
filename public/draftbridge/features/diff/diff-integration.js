/**
 * DraftBridge Compare Changes Integration
 * 
...
const DiffIntegration = (function() {
    ...
    function setupIntegration() {
        ...
        window.DraftBridge = window.DraftBridge || {};
        window.DraftBridge.getCurrentFields = getCurrentFields;
        window.DraftBridge.takeSnapshot = takeFieldSnapshot;
        window.DraftBridge.showDiffPreview = showDiffPreview;
        window.DraftBridge.getDiffSummary = getDiffSummary;
