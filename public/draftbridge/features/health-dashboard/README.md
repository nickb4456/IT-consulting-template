...
```javascript
import DraftBridgeHealthDashboard from './health-dashboard.js';

// Quick one-liner
const report = await DraftBridgeHealthDashboard.quickCheck();
...
The dashboard integrates with existing DraftBridge features:
