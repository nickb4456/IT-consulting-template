/**
 * DraftBridge First-Run Onboarding
 * 
 * Creates the magical first-run experience that Steve Jobs demanded.
 * "Welcome to DraftBridge. Open any document and I'll show you something amazing."
 * 
 * Design Philosophy:
...
const ONBOARDING_KEY = 'draftbridge_onboarding';
...
const MICROCOPY = {
    ...
    scanning: {
        ...
        tip: "DraftBridge detects [[ ]] and {{ }} style placeholders"
    },
    fields: {
    ...
    tips: {
        firstScan: "💡 DraftBridge will remember these fields for next time",
        get firstFill() {
...
if (typeof window !== 'undefined') {
    window.DraftBridgeOnboarding = DraftBridgeOnboarding;
}
